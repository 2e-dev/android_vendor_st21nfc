...
#PRODUCT_COPY_FILES += \
#      $(NFC_RF_CONFIG_PATH)/st54j_conf.txt:$(TARGET_COPY_OUT_VENDOR)/etc/st54j_conf.txt:st
...
ifneq ($(strip $(TARGET_BUILD_VARIANT)),user)
   ...
   vendor/st/nfc/st21nfc/conf/libnfc-hal-st.conf.st54j:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-hal-st.conf:st
else
  # Configuration files for user build, remove some logs for GSMA certif
   ...
   vendor/st/nfc/st21nfc/conf/libnfc-hal-st.conf.st54j.user:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-hal-st.conf:st
endif
