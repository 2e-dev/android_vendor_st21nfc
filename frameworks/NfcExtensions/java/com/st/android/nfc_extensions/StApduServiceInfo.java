...
public final class StApduServiceInfo implements Parcelable {
     ...
     * ProtoOutputStream#end(long)}. See proto definition in
     * frameworks/base/core/proto/android/nfc/apdu_service_info.proto
     *
    ...
    public void dumpDebug(ProtoOutputStream proto) {
        ...
        //        if (!mOnHost) {
        //            proto.write(StApduServiceInfoProto.OFF_HOST_NAME, mOffHostName);
        //            proto.write(StApduServiceInfoProto.STATIC_OFF_HOST_NAME, mStaticOffHostName);
        //        }
        //        for (StAidGroup group : mStaticAidGroups.values()) {
